...
; revised windows, added user instructions
;
; v1.1 release notes - 06/13/2026
; built on -80's monitor
; added cf worker (see gist)
;
; v1.0 release notes - 11/18/2025
...
MsgBox, 48, Active Window is:  "%awin%", Island Performer ONLY!!!`nThis completes a `nPre-Recovery & Post-Dive Checklist.`nJust fill out the following parameters.`n`nYou can leave this screen to get info,`n Just ensure to return to Unisea page before continuing this app.
ScriptName := "Post-Dive-Checklist-IP"
