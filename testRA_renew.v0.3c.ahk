...
mkDB() {
;MsgBox, 0, Start mkDB
InputBox, in_sup, Personnel Names, Supervisor: , , , , , , Locale, 30, Supervisor
if ErrorLevel {
 ExitApp, 0
}
InputBox, in_sr, Personnel Names, Sr. Technician: , , , , , , Locale, 30, Sr. Tech
if ErrorLevel {
 ExitApp, 0
}
InputBox, in_pt, Personnel Names, Pilot Technician: , , , , , , Locale, 30, PT
if ErrorLevel {
 ExitApp, 0
}
